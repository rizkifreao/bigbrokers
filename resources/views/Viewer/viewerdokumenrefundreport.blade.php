    ...
    function initPage(){
      ...
      function reloadTableByDate(startDate, endDate, jenisAsu, jenisCli){
        ...
        var table = $('#data-table-example2').DataTable({
          ...
          // "serverSide": true,
          "ajax": {
            "url": "./ViewerDokumenRefundReport/reloadTableByDate/"+startDate+"/"+endDate+"/"+jenisAsu+"/"+jenisCli,
            "type": "GET"
          },
          "order": [[ 0, 'asc' ]],
          "footerCallback": function ( row, data, start, end, display ) {
            var api = this.api(), data;
            var colNumber = [15,16,19,21];
      ...
      var table = $('#data-table-example2').DataTable({
          ...
          // "serverSide": true,
          "ajax": {
            "url": "./ViewerDokumenRefundReport/reload",
            "type": "GET"
          },
          "order": [[ 0, 'asc' ]],
          "footerCallback": function ( row, data, start, end, display ) {
        ...
        switch (buttonPressed) {
          ...
          if(tgl_awal == '' || tgl_awal == null){
            ...
            alert('Pilih Jenis Asuransi');
              ...
              var win = window.open("./CetakRefund/"+tgl_awal+"/"+tgl_akhir+"/"+jns_asuransi+"/"+jns_client);
            if (win) {
