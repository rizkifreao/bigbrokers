...
<script type="text/javascript">
      ...
      var table = $('#data-table-example2').DataTable({
          ...
          'columnDefs': [{ 
            ...
            'render': function (data, type, row){
                return '<input type="checkbox" class="m-checkbox m-checkbox--solid m-checkbox--state-success" tenor="'+ row['tenor'] +'" kodeprod="'+ row['kode_prod'] +'" nopk="'+ row['no_pk'] +'" value="'
    ...
    $(document).ready(function() {
      ...
      function reloadTableByjnsCln(jenisClient){
        ...
        $('#data-table-example2 tbody').empty();
          ...
          // "serverSide": true,
          "ajax": {
            "url": "./FormAkeptasiDokumen/reloadby/"+jenisClient,
            "type": "GET"
          },
          'columnDefs': [{ 
            'targets': 0,
    ...
    //     .draw();
            ...
            formData.append('tenordebitur', dokumenID3);
            // alert(dokumenIDs);
