  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h3 class="modal-title" id="myModalLabel">Upload Data Refund</h3>
      </div>
          ...
          <div class="form-group m-form__group row">
            ...
            <div class="col-lg-6">
              <div class="col-lg-12">
                ...
                <div class="input-daterange input-group datepicker-demo">
                  <input type="text" class="form-control  m-input m-input--air m-input--pill" placeholder="Select date" id="tanggalLapor" name="tgl_lapor_refund" autocomplete="off"  placeholder="isi tanggal lapor" />
                  <div class="input-group-append">
                    <span class="input-group-text">
                      <i class="la la-calendar-check-o"></i>
                    </span>
              ...
              <div class="col-lg-12">
                ...
                <div class="input-daterange input-group datepicker-demo">
                  <input type="text" class="form-control  m-input m-input--air m-input--pill" placeholder="Select date" id="tglPelunasan" name="tgl_pelunasan" autocomplete="off"  placeholder="isi tanggal Lunas" />
                  <div class="input-group-append">
                    <span class="input-group-text">
                      <i class="la la-calendar-check-o"></i>
                    </span>
              ...
              <div class="col-lg-12">
                ...
                <input type="text" class="form-control m-input m-input--air m-input--pill" id="nilaiRefund" name="nilai_refund"  >
                <span>
              ...
              <div class="col-lg-12">
                ...
                <div class="input-daterange input-group datepicker-demo">
                  <input type="text" class="form-control  m-input m-input--air m-input--pill" placeholder="Select date" id="tglBayar" name="tgl_bayar" autocomplete="off"  placeholder="isi tanggal Lunas" />
                  <div class="input-group-append">
                    <span class="input-group-text">
                      <i class="la la-calendar-check-o"></i>
                    </span>
              ...
              <div class="col-lg-12">
                ...
                <input type="text" class="form-control m-input m-input--air m-input--pill" id="diBayar" name="dibayar"  >
                <span>
    ...
    function reloadTableByDate(startDate, endDate){
      ...
      var table = $('#data-table-example2').DataTable({
        ...
        "bDestroy": true,
          ...
          // "serverSide": true,
          "ajax": {
            "url": "./FormValidasiRefund/reloadby/"+ startDate +"/"+ endDate,
            "type": "GET"
          },
          // 'columnDefs': [{
          //   'targets': 0,
    ...
    var table = $('#data-table-example2').DataTable({
      ...
      $('#example-select-all').on('click', function(){
        ...
        function tableText(valueIdx) {
                ...
                $(".modal-body").find("#nilaiRefund").val(valueIdx['nilai_refund']);
                $(".modal-body").find("#diBayar").val(valueIdx['dibayar']);
                $(".modal-body").find("#tanggalLapor").val(valueIdx['tgl_lapor']);
                $(".modal-body").find("#tglBayar").val(valueIdx['tgl_bayar']);
                $(".modal-body").find("#noSertifikat").val(valueIdx['no_polis']);
                ...
                $(".modal-body").find("#noSertifikat").prop("disabled", true);
                $(".modal-body").find("#jenisKredit").prop("disabled", true);
                $(".modal-body").find("#noKredit").prop("disabled", true);
                $(".modal-body").find("#Debitur").prop("disabled", true);
                $(".modal-body").find("#tanggalLahir").prop("disabled", true);
                $(".modal-body").find("#tanggalAkad").prop("disabled", true);
                $(".modal-body").find("#masaKredit").prop("disabled", true);
                $(".modal-body").find("#plafonPinjaman").prop("disabled", true);
                $(".modal-body").find("#Premi").prop("disabled", true);
                $(".modal-body").find("#idProdAjk").prop("disabled", true);
                $(".modal-body").find("#jenisAsuransi").prop("disabled", true);
                $(".modal-body").find("#tanggalLapor").prop("disabled", true);
                $(".modal-body").find("#tanggalKejadian").prop("disabled", true);
                $(".modal-body").find("#jenisKlaim").prop("disabled", true);
                $(".modal-body").find("#nilaiRefund").prop("disabled", true);
                $(".modal-body").find("#tglPelunasan").prop("disabled", true);
                $(".modal-body").find("#Umur").prop("disabled", true);
                $(".modal-body").find("#tglAwal").prop("disabled", true);
                $(".modal-body").find("#Plafon").prop("disabled", true);
                $(".modal-body").find("#tglLahir").prop("disabled", true);
        ...
        function clear() {
            ...
            $(document).ready(function() {
              ...
              $('#FormExport').on('submit', function (e) {
                ...
                $.ajax({
                type: 'GET',
                url : "./FormValidasiRefund/cekexportexcel/" + startDate + "/" + endDate,
                ...
                success : function (data) {
                  if(data.status == 'failed'){
                    ...
                    var win = window.open("./FormValidasiRefund/exportexcel/" + startDate + "/" + endDate, '_blank');
                  }
                  reloadtable();
                }
              });
